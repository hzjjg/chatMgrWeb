window.Login = function() {
    var
        ...
        config = this.config = {
            ...
            loginApi: $.trim($('#login-host').val()) + 'api/session',
            ...
            $loginCorpKeyInput: $("input[name='corpKey']"),
            ...
            i18n: {
                ...
                'error-login-corp-key-empty': '请输入公司Key'
        ...
        validateForm = function() {
            ...
            } else if ($.trim(config.$loginCorpKeyInput.val()) == '') {
                showError(i18n['error-login-corp-key-empty']);
                config.$loginCorpKeyInput.focus();
            } else {
                return true;
            }
        },
        getLoginData = function() {
            ...
            return {
                ...
                password: password,
                corpKey: $.trim(config.$loginCorpKeyInput.val()),
