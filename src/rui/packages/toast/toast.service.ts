...
export class ToastService {
    ...
    success(message: string, position: string = 'top') {
        this.show({
            position: position,
            type: 'success',
            message: message,
    ...
    error(message: string, position: string = 'top') {
        this.show({
            position: position,
            type: 'error',
            message: message,
    ...
    warning(message: string, position: string = 'top') {
        this.show({
            position: position,
            type: 'warning',
            message: message,
    ...
    info(message: string, position: string = 'top') {
        this.show({
            position: position,
            type: 'info',
            message: message,
